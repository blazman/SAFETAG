...
preparation: |
  #### Habilidades básicas* Saber identificar elementos maliciosos, fazer varreduras em máquinas e limpá-las* Capacidade de fazer uma pesquisa inicial sobre malware com segurança* Capacidade de criar uma imagem de uma máquina e praticar bons processos de perícia digital e captura de evidências (veja a [Atividade Obter Evidências](https://safetag.org/pt_BR/activities/evidence_capture))* Contatos com especialistas em análise de malware para uma investigação mais aprofundada.
---
