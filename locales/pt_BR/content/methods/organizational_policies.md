---
title: Revisão da Política Organizacional
position: 50
summary: |
  Esta metodologia explora práticas organizacionais existentes, acordos informais e políticas relacionadas ao gerenciamento da segurança da informação e à resposta a ameaças. Ela também busca revelar suposições feitas dentro da organização que não são compartilhadas (informais ou inexistentes) nem codificadas em políticas.
short_summary: Explore as práticas organizacionais existentes, acordos informais e políticas relacionadas à gestão da segurança da informação e à resposta a ameaças.
the_flow_of_information: "![](/img/organizational_policies.png)"
guiding_questions: |
  * Existem políticas ou práticas documentadas, incluindo orientações para quando contratarem funcionários?
  * Qual é o nível de formalidade das práticas de segurança em vigor? São convenções verbais, documentos escritos ou algo entre os dois?
  ...
  * Classificação de informações que limitam o acesso (por exemplo, quem tem acesso a dados financeiros? dados de parceiros?)
  * Backups
...
purpose: |
  ...
  * Identificar recursos para expandir acordos ou formalizar como políticas
  * Lista de verificação de integração (políticas de entrada/saída?)
preparation: |
  Se (por meio de entrevistas ou mesmo do processo de acordo de auditoria) você tiver recebido cópias das políticas, é necessário fazer uma revisão completa das políticas escritas para avaliar se elas estão sendo seguidas, aplicadas ou se foram alteradas desde que foram formalizadas.
---
