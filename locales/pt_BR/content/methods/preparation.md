...
position: 10
summary: |
  'Este componente da auditoria consiste em atividades de preparação da auditoria necessárias para garantir que os componentes da auditoria possam ser conduzidos de forma eficaz e dentro do prazo previsto para a visita ao local.'
short_summary: |
  Este componente consiste em atividades de preparação da auditoria necessárias para garantir que os componentes da auditoria possam ser conduzidos de forma eficaz e dentro do prazo previsto para a visita ao local.
guiding_questions: |
  * A organização possui práticas de segurança digital ou já tentou implementá-las no passado?
  * Quais acordos e contratos regerão a auditoria?
...
info_required: []
outputs: |
  * Um contrato com a organização para receber a auditoria, incluindo escopo, prazo, cláusulas de confidencialidade, medidas ou requisitos mínimos de segurança operacional e pontos de contato.
...
purpose: |
  Uma auditoria SAFETAG tem um prazo curto. Estar preparado é vital para garantir que o tempo no local de auditoria não seja gasto em tarefas como definir o escopo da auditoria, atualizar os sistemas da auditora, procurar equipamentos ou atualizar-se sobre a estrutura SAFETAG. Ter discussões preparatórias prévias com a organização que vai te receber ajudam a revelar se a organização tem capacidade para realizar a auditoria e responder à sua avaliação e recomendações.
preparation: ""
