---
title: Pesquisa de Contexto
position: 20
summary: |
  Esse componente permite que o auditor identifique o contexto regional e tecnológico relevante e necessário para realizar uma auditoria SAFETAG segura e bem informada. Esse componente consiste em uma pesquisa documental coletada e analisada pelo auditor, bem como em informações obtidas na atividade Entrevista.
...
purpose: |
  A análise do contexto é a base para uma gestão de riscos eficaz. Tanto as organizações em risco quanto os auditores vão ter presuposições com base na experiência deles. É importante que uma auditoria seja feita com informações atualizadas e precisas.Verificar as suposições tanto da organização quanto do auditor, pesquisando o contexto regional e tecnológico atual, vai garantir que a pessoa auditora esteja fazendo seu trabalho com base em avaliações precisas das condições que a organização enfrenta e que esteja fazendo considerações informadas sobre segurança operacional.
preparation: ""
---
