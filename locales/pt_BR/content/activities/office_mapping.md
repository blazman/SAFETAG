---
title: Mapeamento do Escritório
approaches:
  - Interpessoal
position: 50
authors:
...
materials_needed: |
  ...
  * Um participante disposto (auditor, membro da equipe) que seja conhecido da equipe e capaz
  de circular e mapear o escritório.
  * Uma câmera (veja as considerações de segurança operacional abaixo)
considerations: |
  ...
  * A localização de certos ativos de alto valor é altamente confidencial e pode ser informação controlada/secreta. Trate com cuidado ao discutir com a organização e, se estiver realizando isso remotamente/com antecedência, certifique-se de que o ponto de contato possa lidar com os dados e destruí-los de forma responsável.
  * Se estiver usando um software de desenho, observe que o uso de ferramentas online gratuitas pode facilmente expor dados confidenciais. Ferramentas offline como LibreOffice Draw, Pencil, ou mesmo Microsoft Powerpoint e Visio funcionam, mas o produto deve ser gerenciado com segurança.
  * Quaisquer fotos tiradas (do desenho do mapa ou de áreas/salas específicas do escritório) devem ser excluídas com segurança ou feitas usando um aplicativo de câmera seguro, como o ObscuraCam
  * É importante observar que o SAFETAG se concentra apenas nos impactos digitais da segurança física. Este guia não fornece uma avaliação completa da segurança física.
walk_through: |
  ...
  * Armários
  * Sala segura
  * Entrada principal do escritório
  * Portas adicionais de entrada/saída
  * Janelas com acesso ao exterior (terraços,térreo, etc.)
  * Escadas de incêndio
  * Acesso à porão /telhado
  * Pessoas (o número de funcionários varia muito, adapte conforme necessário)
  * Diretor executivo
  * Outros diretores
  ...
  * Caixa de fusíveis/rede elétrica
  * Modem a cabo/DSL
  * Roteador/switch de rede
  * Pontos de acesso Wi-Fi e “repetidores”
