---
title: Avaliando o uso dos serviços em nuvem
approaches:
  - Pesquisa
position: 50
authors:
...
walk_through: |
  É cada vez mais difícil administrar organizações complexas sem contar com provedores de serviços baseados em nuvem, como hospedagem de e-mail, hospedagem na web ou gerenciamento/backup de documentos. As organizações (com a ajuda do auditor) devem analisar suas opções na escolha de provedores de nuvem e, ao mesmo tempo, pensar em maneiras de aplicar práticas e políticas ao uso desses serviços para atender aos requisitos de segurança da organização.
recommendations: |
  Programe revisões regulares (anuais?) dos serviços externos para garantir que eles atendam aos requisitos organizacionais de funcionalidade e segurança, solvência comercial e exportação ou transferência de dados.Ao pensar em formalizar o uso de novos serviços de terceiros, dê uma olhada nas perguntas e processos aqui para ajudar a orientar a sua decisão.
