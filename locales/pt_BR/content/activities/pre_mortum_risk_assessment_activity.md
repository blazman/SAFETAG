...
walk_through: |
  ...
  * Desenhe um símbolo para cada pessoa.
  * Escreva uma etiqueta descrevendo a função ou o cargo de cada um.
  ...
  * Depois de concluir todos os eventos-chave, tire uma foto do quadro branco/guarde o papel gráfico para documentação posterior.
considerations: |
