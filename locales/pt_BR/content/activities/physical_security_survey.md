---
title: Pesquisa de Segurança Operacional
approaches:
  - Interpessoal
  - Pesquisa
position: 50
...
materials_needed: |
  ...
  * Dispositivo para anotações que possa ser protegido.
  * Para suporte remoto, um sistema de videochamada seguro (como o Signal) que funcione com a largura de banda disponível.
considerations: |
  ...
  * Considere o contexto de ameaças se uma ferramenta de pesquisa online for usada para coletar informações e gerenciar o acesso e o armazenamento de dados de forma responsável.
...
walk_through: |
  ...
  * Você considera seu espaço de escritório seguro?
  - Não
  - Sim
  * Quem tem acesso livre ao espaço do escritório e acesso rotineiro após o horário comercial (ou seja, quem pode destrancar o espaço)? Isso pode incluir segurança, limpeza ou outro pessoal de serviços do prédio.
  * Vocês têm políticas e procedimentos para autorizar e limitar o acesso físico não autorizado a sistemas digitais e às instalações em que eles estão alojados?
  - Não
  - Sim
  * Descreva as medidas para restringir o acesso físico aos ítens seguintes:
  * Servidores (servidor de dados, servidor de Internet, etc.)
  * Estações de trabalho/laptops dos usuários
  * Dispositivos de rede (por exemplo, roteadores, switches, etc.)
  * Impressoras
  ...
  **Controles de dispositivos**
  ...
  - Sim
  * Se sim, destaque-os.
  * Vocês têm um funcionário responsável pela segurança dos recursos digitais?
  - Não
  - Sim
  * Vocês possuem políticas que abrangem a segurança de laptops (por exemplo, trava com cabo ou armazenamento seguro)?
  - Não
  - Sim
  * Existem procedimentos para bloquear automaticamente os dispositivos digitais se forem deixados sem supervisão por algum tempo?
  - Não
  - Sim
  ...
  **Planejamento de emergência**
  ...
  - Não
  - Sim
  Se sim, destaque as medidas tomadas.
  O plano identifica áreas e instalações que precisam ser isoladas imediatamente em caso de emergência?
  - Não
  - Sim
  ...
  * Que tipo de financiamento a organização recebe?
  * A organização possui um nome de domínio ou identidade de marca que é usado para todas as comunicações online?
  * A organização possui um funcionário responsável por trabalhar com tecnologia digital ou móvel?
  Com que frequência os funcionários da organização viajam para fora do seu país?
  * A organização realiza alguma das seguintes atividades quando viaja internacionalmente?
  * Executa programas
  ...
  * O governo, funcionários públicos, atores não estatais, polícia ou forças de segurança utilizam tecnologia digital ou móvel para identificar e visar indivíduos para prisão ou violência
  * O governo, funcionários públicos, atores não estatais, polícia ou forças de segurança utilizam tecnologia digital ou móvel para atacar a reputação de indivíduos ou organizações
  * De acordo com o seu conhecimento, com que frequência os atores abaixo utilizam tecnologia digital ou móvel para identificar indivíduos para prisão ou violência? Eles nunca, às vezes ou frequentemente utilizam essa tecnologia?
  * Governo ou funcionários públicos
  * Atores não estatais (empresas, grupos econômicos ou sociais)
  * Polícia, forças de segurança ou grupos paramilitares
  * E com que frequência diria que estes atores utilizam tecnologias digitais ou móveis para monitorizar ou recolher informações sobre as atividades da sociedade civil? Nunca, algumas vezes ou frequentemente?
  * Governo ou funcionários públicos
  * Atores não estatais (empresas, grupos econômicos ou sociais)
  * Polícia, forças de segurança ou grupos paramilitares
  * Na sua opinião, quais são as ameaças digitais mais imediatas e graves para a organização?
  * Qual o risco que você considera que cada uma dessas ameaças digitais representa para sua organização?
  * Vigilância online
  * Ataque DDOS (Distributed Denial of Service)
  * Alvo de violência física com base em atividades digitais
  * Perda de dados
  * Outros
  * Você acha que alguma dessas ameaças coloca em risco a segurança física de sua equipe?
  * Você acha que alguma dessas ameaças coloca em risco a segurança física de partes interessadas?
  * Você acha que alguma dessas ameaças coloca em risco a segurança física dos seus beneficiários?
  * Nos últimos seis meses, você ou algum de seus colegas da sociedade civil passou por alguma das seguintes situações?
  * Intimidação ou ameaças de violência por parte de funcionários públicos, polícia ou forças de segurança
  * Intimidação ou ameaças de violência por parte de atores privados ou não estatais
  * Ameaças de prisão ou detenção
  * Encarceramento
  * Ameaças de tortura
  * Confisco de equipamentos
  * Ameaças à situação administrativa, tais como a retirada de credenciais profissionais ou licenças de organizações
  * Outros
  * Como sua organização respondeu a essas ameaças?
  * Abordou a questão na imprensa/online
  * Informou outras organizações sobre a ameaça
  * Entrou em contato com autoridades
  * Treinou a equipe para prevenir e mitigar tais ameaças no futuro
  * Solicitou ajuda de outras organizações
  * Investiu em hardware
  * Angariou fundos
  * Não respondeu
  * Outros
  ...
  * Existe algum software de monitoramento de sistemas em uso?
  * Quais são os servidores e aplicativos mais críticos?
  * A sua organização utiliza backups?
