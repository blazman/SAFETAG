...
[^PETS_emergency_contact]:["Obviamente, ser capaz de entrar em contato com o cliente ou a organização alvo em caso de emergência é vital."](https://www.pentest-standard.org/index.php/Pre-engagement#Emergency_Contact_Information)

[^pets_pre-engagement_location]:[Determinação do local da auditoria - Padrão de execução de testes de penetração: diretrizes pré-contratação](https://www.pentest-standard.org/index.php/Pre-engagement#Locations)
...
[^PETS_evidence_handling]:["Ao lidar com evidências de um teste e as diferentes etapas do relatório, é extremamente importante ter  cuidado extremo com os dados. Sempre use criptografia e limpe sua máquina de teste entre os testes."](https://www.pentest-standard.org/index.php/Pre-engagement#Evidence_Handling)

<!-- Notes -->

[^external_funding_and_reporting]:Normalmente, ao trabalhar com um financiador externo, é criado um relatório de compromisso, sem dados confidenciais sobre a organização anfitriã, para apresentar ao financiador. O conteúdo deste relatório deve ser claramente delineado e acordado durante a fase do plano de avaliação.
...
[^PETS_legal_considerations]:[" Algumas atividades comuns em testes de penetração podem violar as leis locais. Por esse motivo, é recomendável verificar a legalidade das tarefas comuns de pentest no local onde o trabalho será realizado."](https://www.pentest-standard.org/index.php/Pre-engagement#Legal_Considerations)
...
[^PETS_third_parties]:[Lidando com terceiros - O Padrão de Execução de Testes de Penetração](https://www.pentest-standard.org/index.php/Pre-engagement#Dealing_with_Third_Parties)

[^PETS_separate_permissions]: ["Além disso, alguns prestadores de serviço exigem aviso prévio e/ou permissão separada antes de testar seus sistemas. Por exemplo, a Amazon tem um formulário de solicitação online que deve ser preenchido, e a solicitação deve ser aprovada antes de qualquer varredura em seus hosts na nuvem. Se isso for necessário, deve fazer parte do documento."](https://www.pentest-standard.org/index.php/Pre-engagement#Permission_to_Test)

[^PETS_host_and_ip]:["Antes de iniciar um teste de penetração, todos os alvos devem ser identificados."](https://www.pentest-standard.org/index.php/Pre-engagement#Specify_IP_Ranges_and_Domains)
...
[^NIST_incident_repose_plan]:["O plano de avaliação deve fornecer orientações específicas sobre a resposta a incidentes no caso de os avaliadores causarem ou descobrirem um incidente durante o curso da avaliação. Esta seção do plano deve definir o termo ‘incidente’ e fornecer diretrizes para determinar se um incidente ocorreu ou não. O plano deve identificar pontos de contato primários e alternativos específicos para os avaliadores... O plano de avaliação deve fornecer instruções claras sobre as ações que os avaliadores devem tomar nessas situações."](https://csrc.nist.gov/publications/nistpubs/800-115/SP800-115.pdf#page=52)

[^PETS_permission_to_test]:["Um dos documentos mais importantes que precisam ser obtidos para um teste de penetração é o documento de Permissão para Testar."](https://www.pentest-standard.org/index.php/Pre-engagement#Permission_to_Test)
...
[^HCD_toolkit]:["Kit de ferramentas de design centrado no ser humano da IDEO"](https://www.ideo.com/work/human-centered-design-toolkit)
