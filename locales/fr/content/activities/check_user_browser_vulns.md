...
summary: |
  ...
  mis à jour.
short_summary: |
   S'assurer que les navigateurs utilisés ont des plugins mis à jour et sont eux-mêmes mis à jour.
materials_needed: |
  * Metasploit
walk_through: |
...
skills_required: []
overview: |
   Utiliser des méthodes d'accès direct, d'interview, de walk-throughs ou de tests de pénétration pour identifier les navigateurs vulnérables.
recommendations: |
