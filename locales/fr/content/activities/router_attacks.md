...
short_summary: |
   Vérifiez les routeurs pour les mots de passe par défaut, les micrologiciels non corrigés, les vulnérabilités, l'accès à distance et les erreurs de configuration.
overview: |
