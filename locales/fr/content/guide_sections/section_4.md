...
La mission de la communauté SAFETAG est d'améliorer la sécurité des organisations de la société civile dans le monde entier.

Ce que nous faisons : La communauté collabore activement pour partager des connaissances, renforcer les capacités et créer des ressources, tout en promouvant la transparence et la responsabilité parmi ses membres, ainsi qu'avec d'autres communautés de pratiques.
...
* Certains membres de la Communaté de Pratique peuvent avoir des préoccupations en matière de confidentialité et doivent rejoindre la communauté en utilisant un pseudonyme avec lequel ils se sentent à l'aise pour interagir en ligne dans des espaces publics et privés.
* Joining the community: While housed within the orgsec.community, the SCoP will follow the joining process on that list.
* La Communauté de Pratique est responsable du respect du Code de Conduite SAFETAG, ci-dessous

#### Code de Conduite SAFETAG

Les membres de la communauté SAFETAG doivent :

* Respecter les entités auditées et leurs contextes (y compris le cadre juridique dans lequel elles fonctionnent) et protéger leur vie privée et leur sécurité ;
* Protéger les renseignements qui permettent d’identifier et les résultats d’audit des entités auditées, à moins que vous ne disposiez du consentement total et éclairé de l’entité auditée, et même dans ce cas, faire preuve d’une extrême prudence.
...
* Minimiser tout conflit d’intérêts en faisant preuve de transparence dans vos contrats, dans vos rapports et dans vos recommandations ; par exemple, si votre contrat initial ne prévoit pas de mettre en œuvre des recommandations, proposez d’autres options que vous-même pour la mise en œuvre, et fournissez des rapports qui permettront à cette mise en œuvre d’être couronnée de succès dans tous les cas.
* Effectuer votre travail de manière responsable et correcte. Consulter les autres membres de la communauté ;
