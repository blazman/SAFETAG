---
title: Guía - Apéndices
---

# APÉNDICES

## APÉNDICE: Código de Conducta y Gobernanza de SAFETAG

### Declaración de Misión: 

La misión de la comunidad SAFETAG es mejorar la seguridad de organizaciones de la sociedad civil alrededor del mundo.

Qué hacemos: La comunidad colabora activamente para compartir conocimiento, construir capacidad y crear recursos, promoviendo al mismo tiempo transparencia y responsabilidad entre sus miembros, como así también con otras comunidades de práctica.

### Estándares de la Comunidad

La Comunidad de Práctica SAFETAG (SCoP) será un grupo cerrado y privado, alojado inicialmente dentro del servidor de listas orgsec.community existente.

* Los miembros de la comunidad son alentados a ser activos - contribuyendo positivamente/conduciendo discusiones en canales comunitarios, creando, conservando o revisando contenido por pares, o contribuyendo a la lista de cuestiones. Habrá un hilo de "introducción" anual en el servidor de listas en donde se espera que todos los miembros SCoP respondan con una breve nota sobre actividades (compartibles) en curso.
* Algunos miembros SCoP pueden tener preocupaciones acerca de la privacidad, y debieran unirse a la comunidad empleando un seudónimo con el que estén confortables, y puedan entablar una conversación en línea en espacios tanto públicos como privados.
* Uniéndose a la comunidad: Mientras esté alojado en orgsec.community, la SCoP seguirá el proceso de unión a esa lista.
* La SCoP es responsable por la adhesión al Código de Conducta SAFETAG, presentado debajo

#### Código de Conducta SAFETAG

De los miembros de la comunidad SAFETAG se espera que:

* Respeten a los auditados, sus contextos (incluyendo el marco legal dentro del que operan) y protejan su privacidad y seguridad
* Protejan la información identificatoria y las conclusiones de la auditoría acerca de los auditados, a menos que tengan consentimiento completo e informado de los mismos -- y aún así, ejerzan extremo cuidado.
* Nunca usen su conocimiento, habilidades y/o acceso para dañar a sus pares o las organizaciones o comunidades con las que estén trabajando, ya sea por malicia u omisión.
* Minimicen cualquier conflicto de interés a través de la transparencia en la contratación, informe y recomendaciones; ej. si no fuera inicialmente contratado para implementar recomendaciones, sugerir otras opciones que no lo involucren, y proveer un informe que permita que sean exitosas en cada caso.
* Hagan su trabajo responsablemente y bien. Pregunten y consulten con miembros colegas de la comunidad.
* Respeten a otros miemvros de la comunidad como pares, y promuevan un entorno seguro, inclusivo y libre de acoso.

#### Administrador de la Comunidad

Habrá, dado que los fondos están disponibles, una de pago **community manager** que tiene al menos una cuarta parte de su tiempo para apoyar el SAFETAG de la comunidad y de contribuir y apoyar a la comunidad en general en torno a las ONG de seguridad de la organización. Este administrador de la comunidad debe rotar entre las organizaciones de ejecución sustancial de seguridad de la organización de trabajo. Puede haber lagunas y/o solapamientos debido al proyecto y el personal que las necesidades de financiamiento; es importante que las organizaciones encargadas de coordinar la financiación de esta posición con el fin de minimizar esto.

El CM del papel es el de cultivar, de apoyo, y hacer crecer la comunidad. Esto incluye, pero no está limitado a:

* Proponer, planificar y facilitar las conversaciones para apoyar a una comunidad activa y dinámica
...
* La gestión de la infraestructura técnica (página web, repositorio de contenido)
* Proporcionar, al menos, los informes trimestrales a la comunidad de resumir la actividad, tales como nuevos contenidos, herramientas de apoyo o interfaces, nuevas oportunidades y nuevos miembros


* Programación y unirse a reuniones de la Junta Asesora para participar, así como tomar las notas pertinentes.
* Documentar las actividades, funciones y retos para el futuro los administradores de la comunidad.
...
* La Junta es responsable de la administración de la SAFETAG marco y de apoyo y asesoramiento en la CM.
...
## APÉNDICE: Cómo contribuir a SAFETAG

### Contribuir a SAFETAG
...
### La Creación de Contenido de Directrices

*Esta sección le ayuda a caminar a pesar de cómo SAFETAG se construye, y qué piezas de contenido son importantes para proporcionar en una presentación. Los envíos que no cumplan con estas directrices va a tomar mucho más tiempo para ser incorporados.*



SAFETAG tiene actualmente tres principales compilados de productos - un **guía de introducción**, el **guía completa** y una **planes de estudio** para ayudar a entrenar a los nuevos auditores. Esta guía se centra principalmente en la no-curriculares SAFETAG contenido. El Currículo es basado en ADIDS  en la formación en SAFETAG contenido (leer más acerca de los programas de estudio contenido en [https://github.com/SAFETAG/SAFETAG/wiki/Curricula-Document-Template](https://github.com/SAFETAG/SAFETAG/wiki/Curricula-Document-Template)
...
| Section|ADIDS|Guía|Información general|Definition|
|--|-|-|-|---------------------------------------------------------------------|
| Quote|-|-|-|OPTIONAL: No longer included in the compiled guides, but an introductory / framing quote for the section|
| Resumen|-|+|+|A short - two to three sentence - basic overview of the methodology -- What is the auditor doing , what are the high-level outputs and processes?|
| Propósito|+|+|+|The justification for why this methodology is used -- Why is this collection of activities being pursued? what is the end goal?|
...
| Preguntas Orientadoras|+|+|+|Each audit activity is guided by a small set of core questions. Key questions are included to help an auditor identify when they have acquired enough information and customize their approach while still collecting the correct types of information to support the organization -- What are specific guiding or research questions to be answered by conducting activities in pursuit of the larger goal?|
| Resultados|-|+|-|The data or impact is expected from this method -- What are specific outputs to aim for? These should further clarify the information flow diagram above.|
| Seguridad Operacional|-|+|+|OPTIONAL: Operational Security considerations -- Does pursuing this objective have any broad operational security challenges to be aware of that is not otherwise captured in the per-activity detail?|
| Preparación|-|+|-|OPTIONAL: Any preparation, skills, or materials needed for the method as a whole.  Individual exercises will specify this more exactly -- What must an auditor do to prepare for this work that is not otherwise captured in the per-activity detail?|
| Enfoques|-|+|+|No longer used - this was a high-level bullet list of potential activities; now specific activities should be refernced or created instead, and other relevant method-level content should be moved to other sections as relevant. |
| Recursos|-|+|-| Resources should include not only the research used in the creation of the method, but also recommended reading, references, and additional options for conducting this work -- What references did you use in creating this method?  Are there references which provide activity style walkthroughs or additional backgrounds? Are there existing collections of references (in the references folder) that an auditor should review when looking at this methodology.|
...
| Section|ADIDS|Guía|Información general|Definition|
|--|-|-|-|---------------------------------------------------------------------|
| Resumen|-|+|-|A concise description of the exercise. This describes the vulnerability of class of vulnerabilities (e.g. "PHP is out of date") and its overall impact -- What does this specific activity accomplish?|
| Información general|-|+|-|A short, bulleted list that clarifies the general steps, especially for cases where the walkthrough is very complex or involves multiple or parallel processes.  Also included when only referencing an exercise from a method, instead of including the full exercise.|
| Materiales necesarios|-|+|-|Optional; does this require specific software, hardware, or preparation?|
| Consideraciones|-|+|-|Optional; Notes on safely carrying out the activity and protecting the data collected, as well as other challenges (psycho-social, legal, ethical) to be aware of -- Are there operational security concerns, or important baseline skills to master before undertaking this activity?|
...
| Section | ADIDS | Guía | Información general | Description |
|--|-|-|-|---------------------------------------------------------------------|
| Title Page | + | + | + | Can be customized for your needs, locally only |
| Licencia | + | + | + | Please do not change the License |
| Introducción | - | + | + | Welcome language |
| Información general | - | + | + | An overview of the SAFETAG approach and the audit life-cycle|
| "Metro" Map | + | + | + | |
| Evaluación de Riesgo | | + | + | |
| Desarollo de Capacidades | | + | + | |
| Seguridad Operacional | - | + | - | Overall operational security concerns for the assessment process |
| Preparación | - | + | + | How to prepare to conduct an assessment |
...
#### Lista de Comprobación del Juego de Viaje
