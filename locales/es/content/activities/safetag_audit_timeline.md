...
summary: |
   Esta sección provee una guía para crear un cronograma realístico de auditoría para tu plan de evaluación.
materials_needed: ""
walk_through: |
...
skills_required: []
overview: |
   Revisa estas notas en preparación para la auditoría cuando comiences a mapear tu agenda.  Esto provee un lineamiento sugerido basto ce cómo administrar tu tiepo in situ para una auditoría SAFETAG, y algunos recordatorios del trabajo que necesitas haber completado antes de arribar al país. Puedes adaptar este plan o usar sus secciones como plantilla para desarrollar tu propia cronología ajustada al contexto de cada auditoría.
recommendations: ""
---
